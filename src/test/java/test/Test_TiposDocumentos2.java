...
//		DesiredCapabilities caps = new DesiredCapabilities();
	...
	@Test
	public void Script_0375() throws InterruptedException, IOException, InvalidFormatException, AWTException {
		String cp = "DEC_0375";
		// Tipos Doc - crear - Subir archivo - Etiquetas - Valor por defecto(opcional)
		String nombreTipoDocumento = "QA-"+System.currentTimeMillis();
		String fraseEsperada = nombreTipoDocumento+" se creó correctamente";
		System.out.println(cp);
		String resultado = null;
	...
	*/
	...
	@Test
	public void Script_0420() throws InterruptedException, IOException, InvalidFormatException, AWTException {
		String cp = "DEC_0420";
		// Tipos Doc - crear - Plantilla PDF - Accion - Visa
		String nombreTipoDocumento = "QA-"+System.currentTimeMillis();
		String fraseEsperada = nombreTipoDocumento+" se creó correctamente";
		System.out.println(cp);
		String resultado = null;
		...
		pageAcepta.btnAgregarFirmante(cp);
		Thread.sleep(5000);
		
		// datos segundo rol
		pageAcepta.rolRut2(cp, "Admin2");
		pageAcepta.orden2(cp, "1");
		pageAcepta.tipoAccion2(cp, "Visar");
		pageAcepta.estadoEspecificacionPlantillaPdf2(cp, "Visar solo con Pin");
	...
	@Test
	public void Script_0421() throws InterruptedException, IOException, InvalidFormatException, AWTException {
		String cp = "DEC_0421";
		// Tipos Doc - crear - Plantilla PDF - Accion - Visualizar
		String nombreTipoDocumento = "QA-"+System.currentTimeMillis();
		String fraseEsperada = nombreTipoDocumento+" se creó correctamente";
		System.out.println(cp);
		String resultado = null;
		...
		pageAcepta.rolRut2(cp, "Admin2");
		pageAcepta.orden2(cp, "1");
		pageAcepta.tipoAccion2(cp, "Visualizar");
		pageAcepta.estadoEspecificacionPlantillaPdf2(cp, "Compartir");
	...
	@Test
	public void Script_0433() throws InterruptedException, IOException, InvalidFormatException, AWTException {
		String cp = "DEC_0433";
		// Tipos Doc - crear - Plantilla PDF - Accion - Visar solo con Pin
		String nombreTipoDocumento = "QA-"+System.currentTimeMillis();
		String fraseEsperada = nombreTipoDocumento+" se creó correctamente";
		System.out.println(cp);
		String resultado = null;
	...
	@Test
	public void Script_0434() throws InterruptedException, IOException, InvalidFormatException, AWTException {
		String cp = "DEC_0434";
		// Tipos Doc - crear - Plantilla PDF - Accion - Visar solo con Huella
		String nombreTipoDocumento = "QA-"+System.currentTimeMillis();
		String fraseEsperada = nombreTipoDocumento+" se creó correctamente";
		System.out.println(cp);
		String resultado = null;
		...
		pageAcepta.orden2(cp, "1");
		pageAcepta.tipoAccion2(cp, "Visar");
		pageAcepta.estadoEspecificacionPlantillaPdf2(cp, "Visar solo con Huella");
	...
	@Test
	public void Script_0435() throws InterruptedException, IOException, InvalidFormatException, AWTException {
		String cp = "DEC_0435";
		// Tipos Doc - crear - Plantilla PDF - Accion - Visar solo con Clave Unica
		String nombreTipoDocumento = "QA-"+System.currentTimeMillis();
		String fraseEsperada = nombreTipoDocumento+" se creó correctamente";
		System.out.println(cp);
		String resultado = null;
		...
		pageAcepta.orden2(cp, "1");
		pageAcepta.tipoAccion2(cp, "Visar");
		pageAcepta.estadoEspecificacionPlantillaPdf2(cp, "Visar solo con Clave Unica");
	...
	@Test
	public void Script_0436() throws InterruptedException, IOException, InvalidFormatException, AWTException {
		String cp = "DEC_0436";
		// Tipos Doc - crear - Plantilla PDF - Accion - Visar con Firma
		String nombreTipoDocumento = "QA-"+System.currentTimeMillis();
		String fraseEsperada = nombreTipoDocumento+" se creó correctamente";
		System.out.println(cp);
		String resultado = null;
		...
		pageAcepta.orden2(cp, "1");
		pageAcepta.tipoAccion2(cp, "Visar");
		pageAcepta.estadoEspecificacionPlantillaPdf2(cp, "Visar con Firma");
	...
	@Test
	public void Script_0500() throws InterruptedException, IOException, InvalidFormatException, AWTException {
		String cp = "DEC_0500";
		// Tipos Doc - crear - Plantilla Colaborativa - Accion - Visa
		String nombreTipoDocumento = "QA-"+System.currentTimeMillis();
		String fraseEsperada = nombreTipoDocumento+" se creó correctamente";
		System.out.println(cp);
		String resultado = null;
	...
	@Test
	public void Script_0501() throws InterruptedException, IOException, InvalidFormatException, AWTException {
		String cp = "DEC_0501";
		// Tipos Doc - crear - Plantilla PDF - Accion - Visualizar
		String nombreTipoDocumento = "QA-"+System.currentTimeMillis();
		String fraseEsperada = nombreTipoDocumento+" se creó correctamente";
	...
	@Test
	public void Script_0513() throws InterruptedException, IOException, InvalidFormatException, AWTException {
		String cp = "DEC_0513";
		// Tipos Doc - crear - Plantilla Colaborativa - Accion - Visar solo con Pin
		String nombreTipoDocumento = "QA-"+System.currentTimeMillis();
		String fraseEsperada = nombreTipoDocumento+" se creó correctamente";
		System.out.println(cp);
		String resultado = null;
	...
	@Test
	public void Script_0514() throws InterruptedException, IOException, InvalidFormatException, AWTException {
		String cp = "DEC_0514";
		// Tipos Doc - crear - Plantilla PDF - Accion - Visar solo con Huella
		String nombreTipoDocumento = "QA-"+System.currentTimeMillis();
		String fraseEsperada = nombreTipoDocumento+" se creó correctamente";
	...
	@Test
	public void Script_0515() throws InterruptedException, IOException, InvalidFormatException, AWTException {
		String cp = "DEC_0515";
		// Tipos Doc - crear - Plantilla PDF - Accion - Visar solo con Clave Unica
		String nombreTipoDocumento = "QA-"+System.currentTimeMillis();
		String fraseEsperada = nombreTipoDocumento+" se creó correctamente";
	...
	@Test
	public void Script_0516() throws InterruptedException, IOException, InvalidFormatException, AWTException {
		String cp = "DEC_0516";
		// Tipos Doc - crear - Plantilla PDF - Accion - Visar con Firma
		String nombreTipoDocumento = "QA-"+System.currentTimeMillis();
		String fraseEsperada = nombreTipoDocumento+" se creó correctamente";
