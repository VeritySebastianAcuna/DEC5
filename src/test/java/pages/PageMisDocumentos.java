...
public class PageMisDocumentos {
	...
	public void EliminarCarpetaExistente(String caso) throws InterruptedException {
		...
		do {
			try {
				...
				driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/div[1]/div[1]/div[2]/div/div/div[1]/div[4]/button")).click();
				Thread.sleep(1000);
	...
	public void btnEliminarCarpeta(String caso) throws IOException, InvalidFormatException, InterruptedException {
